...
simhash_val1=compute_simhash(freq1)
simhash_val2=compute_simhash(freq2)
...
print("\nLink1: words frequency-\n")
print(freq1)
print("\nlink2: words frequency-\n")
print(freq2)

print("\nsimhas value of first document:",simhash_val1)
print("simhas value of second document:",simhash_val2)

common_bits = count_common_bits(simhash_val1, simhash_val2)
